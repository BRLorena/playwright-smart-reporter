    ...
    <div class="trace-modal-content">
      <div class="trace-modal-header">
        <h3 class="trace-modal-title">
          <span class="trace-modal-icon">${(0, icon_provider_1.icon)('bar-chart-2')}</span>
        ...
        <div class="trace-header-controls">
          <button class="trace-btn trace-btn-small trace-btn-secondary" onclick="toggleFullscreen()" title="Toggle fullscreen">
            <span id="fullscreenIcon">${(0, icon_provider_1.icon)('maximize')}</span>
          </button>
      ...
      <div class="trace-modal-body">
        ...
        <div id="traceError" class="trace-error" style="display: none;">
          <div class="trace-error-icon">${(0, icon_provider_1.icon)('alert-triangle', 24)}</div>
          ...
          <div class="trace-error-actions">
            <button onclick="document.getElementById('traceFileInput').click()" class="trace-btn">
              ${(0, icon_provider_1.icon)('folder')} Load from file
            </button>
            <button id="traceCopyCmd" class="trace-btn trace-btn-secondary">
              ${(0, icon_provider_1.icon)('clipboard')} Copy CLI command
            </button>
          </div>
...
function generateTraceViewerScript() {
      ...
      if (copyCmd) {
        copyCmd.onclick = () => {
          ...
          navigator.clipboard.writeText(cmd).then(() => {
            ...
            setTimeout(() => { copyCmd.innerHTML = '${(0, icon_provider_1.icon)('clipboard')} Copy CLI command'; }, 2000);
          }).catch(() => {
    ...
    function updateSourceTab(action) {
      ...
      if (userFrames.length > 0) {
        html += \`
          <div class="trace-source-section">
            <div class="trace-source-title">${(0, icon_provider_1.icon)('map-pin')} Test Code</div>
      ...
      if (internalFrames.length > 0) {
        html += \`
          <div class="trace-source-section">
            <div class="trace-source-title">${(0, icon_provider_1.icon)('book-open')} Framework Stack</div>
    ...
    function getConsoleIcon(type) {
      const consoleIcons = {
        'log': '${(0, icon_provider_1.icon)('pencil', 12)}',
        'info': '${(0, icon_provider_1.icon)('info', 12)}',
        'warning': '${(0, icon_provider_1.icon)('alert-triangle', 12)}',
        'warn': '${(0, icon_provider_1.icon)('alert-triangle', 12)}',
        'error': '${(0, icon_provider_1.icon)('x-circle', 12)}',
        'debug': '${(0, icon_provider_1.icon)('search', 12)}'
      };
      return consoleIcons[type] || '${(0, icon_provider_1.icon)('pencil', 12)}';
    }
      ...
      metadataContent.innerHTML = \`
        <div class="trace-metadata-grid">
          <div class="trace-metadata-card">
            <div class="trace-metadata-card-title">${(0, icon_provider_1.icon)('globe')} Browser</div>
          ...
          <div class="trace-metadata-card">
            <div class="trace-metadata-card-title">${(0, icon_provider_1.icon)('ruler')} Viewport</div>
            <div class="trace-metadata-row">
          ...
          <div class="trace-metadata-card">
            <div class="trace-metadata-card-title">${(0, icon_provider_1.icon)('monitor')} Platform</div>
            <div class="trace-metadata-row">
          ...
          <div class="trace-metadata-card">
            <div class="trace-metadata-card-title">${(0, icon_provider_1.icon)('clock')} Timing</div>
            <div class="trace-metadata-row">
    ...
    function getActionIcon(method) {
      const actionIcons = {
        'goto': '${(0, icon_provider_1.icon)('globe', 12)}',
        'click': '${(0, icon_provider_1.icon)('mouse-pointer', 12)}',
        'dblclick': '${(0, icon_provider_1.icon)('mouse-pointer', 12)}',
        'fill': '${(0, icon_provider_1.icon)('pencil', 12)}',
        'type': '${(0, icon_provider_1.icon)('pencil', 12)}',
        'press': '${(0, icon_provider_1.icon)('pencil', 12)}',
        'check': '${(0, icon_provider_1.icon)('square-check', 12)}',
        'uncheck': '${(0, icon_provider_1.icon)('square', 12)}',
        'selectOption': '${(0, icon_provider_1.icon)('clipboard', 12)}',
        'hover': '${(0, icon_provider_1.icon)('mouse-pointer', 12)}',
        'focus': '${(0, icon_provider_1.icon)('target', 12)}',
        'blur': '${(0, icon_provider_1.icon)('circle', 12)}',
        'screenshot': '${(0, icon_provider_1.icon)('camera', 12)}',
        'evaluate': '${(0, icon_provider_1.icon)('settings', 12)}',
        'evaluateHandle': '${(0, icon_provider_1.icon)('settings', 12)}',
        'waitForSelector': '${(0, icon_provider_1.icon)('timer', 12)}',
        'waitForTimeout': '${(0, icon_provider_1.icon)('clock', 12)}',
        'waitForLoadState': '${(0, icon_provider_1.icon)('timer', 12)}',
        'waitForNavigation': '${(0, icon_provider_1.icon)('timer', 12)}',
        'waitForURL': '${(0, icon_provider_1.icon)('timer', 12)}',
        'waitForFunction': '${(0, icon_provider_1.icon)('timer', 12)}',
        'expect': '${(0, icon_provider_1.icon)('check', 12)}',
        'toBeVisible': '${(0, icon_provider_1.icon)('eye', 12)}',
        'toHaveText': '${(0, icon_provider_1.icon)('pencil', 12)}',
        'toHaveValue': '${(0, icon_provider_1.icon)('pencil', 12)}',
        'toBeChecked': '${(0, icon_provider_1.icon)('square-check', 12)}',
        'toBeEnabled': '${(0, icon_provider_1.icon)('check', 12)}',
        'toBeDisabled': '${(0, icon_provider_1.icon)('ban', 12)}',
        'toHaveAttribute': '${(0, icon_provider_1.icon)('tag', 12)}',
        'toHaveClass': '${(0, icon_provider_1.icon)('palette', 12)}',
        'toHaveCount': '${(0, icon_provider_1.icon)('bar-chart-2', 12)}',
        'toContainText': '${(0, icon_provider_1.icon)('pencil', 12)}',
        'newPage': '${(0, icon_provider_1.icon)('file', 12)}',
        'newContext': '${(0, icon_provider_1.icon)('file', 12)}',
        'close': '${(0, icon_provider_1.icon)('x', 12)}',
        'setContent': '${(0, icon_provider_1.icon)('file', 12)}',
        'setViewportSize': '${(0, icon_provider_1.icon)('ruler', 12)}',
        'route': '${(0, icon_provider_1.icon)('route', 12)}',
        'unroute': '${(0, icon_provider_1.icon)('route', 12)}',
        'request': '${(0, icon_provider_1.icon)('signal', 12)}',
        'fetch': '${(0, icon_provider_1.icon)('signal', 12)}'
      };
      return actionIcons[method] || '${(0, icon_provider_1.icon)('play', 12)}';
    }
    ...
    function toggleFullscreen() {
      ...
      if (modal) {
        ...
        if (icon) {
          icon.innerHTML = modal.classList.contains('fullscreen') ? '${(0, icon_provider_1.icon)('minimize', 14)}' : '${(0, icon_provider_1.icon)('maximize', 14)}';
        }
      }
    }
          ...
          \${traceAttachments.slice(0, 20).map((att, idx) => \`
            <div class="trace-attachment-card">
              <div class="trace-attachment-preview">
                \${att.type === 'image' ? \`<img src="\${att.dataUri}" alt="\${escapeHtmlTrace(att.name)}" onclick="openAttachmentPreview(\${idx})">\` : \`<span class="trace-attachment-preview-icon">${(0, icon_provider_1.icon)('paperclip', 24)}</span>\`}
              </div>
