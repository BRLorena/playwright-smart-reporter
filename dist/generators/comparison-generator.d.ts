 ...
 */
import type { RunComparison, RunSummary, TestResultData } from '../types';
/**
 * Generate comparison view between current and baseline runs
 */
export declare function generateComparison(comparison: RunComparison): string;
/**
 * Generate JavaScript for comparison functionality
 */
export declare function generateComparisonScript(): string;
/**
 ...
 */
export declare function buildComparison(currentTests: TestResultData[], currentSummary: RunSummary, baselineSummary: RunSummary, baselineTests: Map<string, TestResultData>): RunComparison;
